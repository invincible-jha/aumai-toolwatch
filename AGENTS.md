# Agent Instructions for Toolwatch

## Project Context
Toolwatch is an open source Detect runtime changes in tool behavior via fingerprinting.

## Repository Layout
- `src/aumai_toolwatch/` — package source
