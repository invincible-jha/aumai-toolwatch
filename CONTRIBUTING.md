# Contributing to AumAI Toolwatch
...
### Setup
```bash
git clone https://github.com/aumai/aumai-toolwatch.git
cd aumai-toolwatch
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-toolwatch/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-toolwatch/discussions)
